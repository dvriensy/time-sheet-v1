  ...
  return (
    <div id="dashboard-view" className="space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-lg sm:text-xl font-semibold text-main-text">Analytics Dashboard</h1>
        ...
        <button
          ...
          className="w-full sm:w-auto flex items-center justify-center gap-2 rounded-xl border border-main-border bg-card-bg px-4 py-2.5 text-xs font-medium text-main-text hover:bg-input-bg transition cursor-pointer"
        >
          {privacyMode ? (
            <>
            ...
            <>
              <EyeOff className="h-4 w-4 text-muted-text shrink-0" />
      ...
      {/* Metrics Cards Grid - Stacks to single column on mobile */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        {/* Metric 1 */}
        <div className="rounded-2xl sm:rounded-3xl border border-main-border bg-card-bg p-4 sm:p-5 shadow-lg">
          ...
          <div className="mt-3 sm:mt-4">
            <h3 className="text-xl sm:text-2xl font-semibold text-main-text tracking-tight font-mono">
              {stats.totalHours} <span className="text-xs font-normal text-muted-text font-sans">hrs</span>
            </h3>
        ...
        <div className="rounded-2xl sm:rounded-3xl border border-main-border bg-card-bg p-4 sm:p-5 shadow-lg">
          ...
          <div className="mt-3 sm:mt-4">
            <h3 className="text-xl sm:text-2xl font-semibold text-main-text tracking-tight font-mono">
              {formatCurrency(stats.avgRate)}<span className="text-xs font-normal text-muted-text font-sans">/hr</span>
            </h3>
        ...
        <div className="rounded-2xl sm:rounded-3xl border border-main-border bg-card-bg p-4 sm:p-5 shadow-lg">
          ...
          <div className="mt-3 sm:mt-4">
            <h3 className="text-xl sm:text-2xl font-semibold text-main-text tracking-tight font-mono">
              {stats.projectCount} <span className="text-xs font-normal text-muted-text font-sans">active</span>
            </h3>
      ...
      {/* Main Charts Area - Stacks to single column on mobile */}
      <div className="grid grid-cols-1 gap-4 sm:gap-6 lg:grid-cols-3">
        
        {/* Weekly Hours Workload (Bar Chart) */}
        <div className="lg:col-span-2 rounded-2xl sm:rounded-3xl border border-main-border bg-card-bg p-4 sm:p-6 shadow-xl overflow-hidden">
          ...
          <div className="h-64 sm:h-72 w-full overflow-x-auto">
            <div className="min-w-[320px] sm:min-w-0 h-full">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={weeklyData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                  ...
                  />
                  <Bar dataKey="Hours" fill="url(#hoursGrad)" radius={[4, 4, 0, 0]} barSize={36} />
                  <defs>
        ...
        <div className="rounded-2xl sm:rounded-3xl border border-main-border bg-card-bg p-4 sm:p-6 shadow-xl flex flex-col justify-between overflow-hidden">
          <div>
          ...
          <div className="h-44 sm:h-48 w-full flex items-center justify-center relative my-3 sm:my-4">
            ...
            <div className="absolute flex flex-col items-center pointer-events-none">
              ...
              <span className="text-base sm:text-lg font-bold text-main-text">{stats.projectCount}</span>
            </div>
          </div>
          {/* Custom Legends */}
      ...
      <div className="rounded-2xl sm:rounded-3xl border border-main-border bg-card-bg p-4 sm:p-6 shadow-xl overflow-hidden">
